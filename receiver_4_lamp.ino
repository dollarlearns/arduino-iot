/**
 * @file receiver_4_lamp.ino
 * Lamp light device on channel 4
 * @brief RF24 Wireless Communication Sketch from Arduino UNO to receive data from Raspberry Pi on channel 4 and control device
